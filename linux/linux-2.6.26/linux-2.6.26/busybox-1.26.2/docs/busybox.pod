...
Currently available applets include:
	...
	acpid, adjtimex, arp, arping, ash, bash, beep, blkdiscard, blkid,
	blockdev, brctl, bunzip2, bzcat, bzip2, cat, chat, chattr, chmod,
	chown, chpst, chroot, chrt, clear, conspy, cp, cpio, crond, crontab,
	cttyhack, dc, depmod, devmem, dhcprelay, dmesg, dnsd, dnsdomainname,
	dpkg, dpkg-deb, dumpleases, echo, ed, eject, env, envdir, envuidgid,
	ether-wake, fakeidentd, fatattr, fbset, fbsplash, fdflush, fdformat,
	fdisk, find, findfs, flock, free, freeramdisk, fsck, fsck.minix,
	fstrim, ftpd, ftpget, ftpput, fuser, getopt, grep, groups, gunzip,
	gzip, hd, hdparm, head, hexdump, hostid, hostname, httpd, hush,
	hwclock, i2cdetect, i2cdump, i2cget, i2cset, id, ifconfig, ifdown,
	ifenslave, ifplugd, ifup, inetd, insmod, install, ionice, iostat,
	ip, ipaddr, ipcalc, ipcrm, ipcs, iplink, ipneigh, iproute, iprule,
	iptunnel, kill, killall, killall5, klogd, last, less, linux32,
	linux64, ln, logger, logread, losetup, lpd, lpq, lpr, ls, lsattr,
	lsmod, lsof, lspci, lsusb, lzcat, lzma, lzop, lzopcat, makedevs,
	man, mdev, microcom, mkdir, mkdosfs, mke2fs, mkfs.ext2, mkfs.minix,
	mkfs.vfat, mkswap, mktemp, modinfo, modprobe, more, mount,
	mountpoint, mpstat, mt, mv, nameif, nanddump, nandwrite, nbd-client,
	nc, netstat, nmeter, nsenter, nslookup, ntpd, patch, pgrep, pidof,
	ping, ping6, pivot_root, pkill, pmap, powertop, ps, pscan, pstree,
	pwd, pwdx, raidautorun, rdate, rdev, readahead, readprofile,
	realpath, renice, reset, rev, rm, rmdir, rmmod, route, rpm,
	rpm2cpio, rtcwake, runlevel, runsv, runsvdir, rx, script,
	scriptreplay, setarch, setserial, setsid, setuidgid, sh, showkey,
	slattach, sleep, smemcap, softlimit, split, stat, strings, stty, sv,
	...
	umount, uname, uniq, unlink, unlzma, unlzop, unshare, unxz, unzip,
	uptime, users, usleep, vconfig, volname, wall, watch, watchdog, wc,
	wget, which, who, whoami, whois, xz, xzcat, yes, zcat, zcip
